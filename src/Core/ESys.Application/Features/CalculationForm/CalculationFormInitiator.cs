...
namespace ESys.Application.Features;
public class CalculationFormInitiator
{
    ...
    public CalculationFormInitiator(IBizRepository bizRepository, IConfiguration configuration)
    {
